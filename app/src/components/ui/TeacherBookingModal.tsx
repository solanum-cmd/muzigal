...
export default function TeacherBookingModal({ isOpen, onClose, teacher }: TeacherBookingModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-xl w-full max-w-md overflow-hidden relative animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6">
                    <h2 className="text-[20px] font-bold text-[#132742] mb-1">Book Free Trial</h2>
                    <p className="text-[13px] text-[#6b7280] mb-6">with {teacher.name}</p>
                    ...
                    {success ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-600">Your trial request has been received. We will contact you shortly to schedule it.</p>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-2.5 rounded-lg border border-[#e0e0e0] text-[14px] focus:outline-none focus:border-[#d63384] focus:ring-1 focus:ring-[#d63384]"
                                    placeholder="Any specific requirements or preferred times..."
                                />
                            </div>
