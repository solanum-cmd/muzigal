...
interface EnquiryModalProps {
    isOpen: boolean;
    onClose: () => void;
    academy: typeof academies[0];
}

export default function EnquiryModal({ isOpen, onClose, academy }: EnquiryModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-4">
            <div className="bg-white rounded-xl w-full max-w-md overflow-hidden relative animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-6">
                    <h2 className="text-[20px] font-bold text-[#132742] mb-1">Enquire Now</h2>
                    <p className="text-[13px] text-[#6b7280] mb-6">for {academy.name}</p>
                    ...
                    {success ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-gray-600">We have received your enquiry and will get back to you shortly.</p>
                        </div>
                    ) : (
